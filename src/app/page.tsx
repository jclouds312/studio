                        ...
                        <CarouselItem key={job.id} className="md:basis-1/2 lg:basis-1/3">
                            <div className="p-1">
                                <Link href={`/jobs/${job.id}`} className="block h-full group">
                                    <Card className="hover:shadow-xl transition-all duration-300 transform group-hover:scale-105 group-hover:border-primary/50 relative overflow-hidden flex flex-col h-full min-h-[250px]">
